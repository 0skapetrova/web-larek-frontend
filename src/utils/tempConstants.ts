import { OrderResponse, ProductsResponse } from "../base/AppApi";
import { IClient, IOrder, IProduct } from "../types";

export const testProducts: ProductsResponse<IProduct> = {
        "total": 10,
        "items": [
            {
...
export const testOrder: OrderResponse = {
...
export const testClient: IClient = {
    "payment": "online",
    "email": "test@test.ru",
    "phone": "+71234567890",
...
export const testOrderData: IOrder = {
    "payment": "online",
    "email": "test@test.ru",
    "phone": "+71234567890",
    "address": "Spb Vosstania 1",
